...
export const CaseStudyFooterTangle: React.FC<Props> = ({
    ...
    return (
        <div ref={ref} className="border-t border-black/5 overflow-hidden relative" style={{ background: '#f8f7f5' }}>
            ...
            <div className="py-28 px-10 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg mx-auto">
                    ...
                    <p className="font-serif text-4xl md:text-5xl text-black/85 mb-10 leading-tight">
                        Thanks for reading.
                    </p>
                    <button
                        onClick={onBack}
