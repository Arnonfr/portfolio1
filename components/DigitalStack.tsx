...
const TOOLS: Tool[] = [
    ...
    { id: 'codex', name: 'Codex', logo: '/images/tools/codex.svg' },
    { id: 'chatgpt', name: 'ChatGPT', logo: '/images/tools/chatgpt.svg' },
    { id: 'midjourney', name: 'Midjourney', logo: '/images/tools/midjourney.svg' },
    ...
    { id: 'antigravity', name: 'Antigravity', logo: '/images/tools/antigravity.svg' },
    ...
    { id: 'notion', name: 'Notion', logo: '/images/tools/notion.svg' },
...
export const DigitalStack: React.FC = () => {
    ...
    const startClaw = useCallback(() => {
        ...
        const targetCableLength = Math.max(0, ((targetPos.y / 100) * activeContainerH) - 80);
            ...
            <div className="relative px-container max-w-7xl mx-auto z-10">
                ...
                <div className="flex flex-col md:flex-row gap-0">
                    <div className="w-full md:w-3/4 flex-shrink-0">
                        ...
                        >
                            <div className="absolute top-12 left-0 right-0 h-2 bg-gradient-to-b from-[#8b8680] to-[#a8a39a] rounded-full shadow-md z-40" />
                            <div className="absolute top-[46px] left-0 right-0 h-1 bg-gradient-to-b from-[#d4cfc7] to-[#bfbab2] rounded-full z-40" />

                            <motion.div
                                className="absolute top-8 z-50 flex flex-col items-center pointer-events-none"
                                style={{ left: clawLeftPercent, x: '-50%' }}
                            >
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: isClawing ? 0.5 : 0.12, ease: isClawing ? [0.33, 1, 0.68, 1] : 'linear' }}
                                    className="w-[2px] bg-gradient-to-b from-[#8b8680] to-[#6b6660] origin-top shadow-sm"
                                    style={{ minHeight: 24 }}
                                />

                                <motion.div
                                    animate={{ rotate: isClawing ? [0, 4, -4, 0] : 0 }}
                                ...
                                >
                                    ...
                                    <div className="flex gap-1 -mt-1 relative">
                                        <motion.div
                                            animate={{ 
                                                rotate: pickedTool ? 22 : (isClawing ? 28 : 20),
                                                x: pickedTool ? 6 : 0
                                            }}
                                            transition={{ type: 'spring', stiffness: 300, damping: 15 }}
                                            className="relative w-[4px] h-10 bg-gradient-to-b from-[#9d988f] to-[#6b6660] rounded-full origin-top shadow-md z-10"
                                        >
                                    ...
                                    <AnimatePresence>
                                        {pickedTool && (
                                            <motion.div
                                                ...
                                                className="absolute top-2 bg-white rounded-xl p-2 shadow-xl border border-gray-100 z-0"
                                            >
